...
RADIOBEHANDLING	BTFSS	PORTA,2
				GOTO	RADIOBEHANDLING
				BSF		PORTA,7			; Tænd for relæet
RADIOLOOP		BTFSC	PORTA,2
				GOTO	RADIOLOOP
				BCF		PORTA,7
				RETURN					; Sluk for relæet


VENT			MOVLW   d'48'			; 5 sekunders pause 
                MOVWF   TELLER
LOOP2           CLRF    TMR0
LOOP1           MOVFW   TMR0
                SUBLW   d'100'
...
MAIN			BTFSC	PORTA, 0		; Tjek om der er lyd fra forstærkeren. Hvis der er, så aktiveres lydbehandling
				GOTO	LYDBEHANDLING	; Gå til lydbehandling
				BTFSC	PORTA, 1		; Tjek om der er strøm fra lyssensoren
