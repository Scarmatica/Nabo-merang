...
SETUP	BCF		STATUS,6			;Dvs ikke bank 2 eller 3 - hhv 'b'10 og 'b'11 for RP1,RP0
		...
		MOVLW	B'00000000'			;Fortæller intern clock skal være 31 kHz (Op til 8 MHz)
...
MAIN
		CLRF	PORTB
		MOVLW	b'00001000'				;Her kommer der til at stå 08 (0 og 8) på de to displays
		MOVWF	PORTB
		CALL	PAUSE
		CALL	PAUSE
		CALL	PAUSE
		...
		CLRF	PORTB	
		MOVLW	b'01000111'				;Her kommer der til at stå 47 (4 og 7) på de to displays
		MOVWF	PORTB
		CALL	PAUSE
		CALL	PAUSE
		CALL	PAUSE
